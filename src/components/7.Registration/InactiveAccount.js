...
const InactiveAccount = () => {
                ...
                await axios
                    ...
                    .then((res) => {
                        if (res.data.status === 1) {
                            ...
                            goTo("/login");
                            setLoading(false);
                            // verifySecurityQuestionForonClickActivateAccountBtn();
                        } else {
                            setLoading(false);
                            setAlertDetails({
                                alertVisible: true,
    ...
    return (
        <Layout>
            <section className="inactive-account section-padding min-100vh">
                <div className="container wrapper">
                    ...
                    >
                        ...
                        <div className="col-xl-5 col-lg-6 col-md-8 order-1 order-lg-2">
                            ...
                            >
                                <h2 className="text-center fw-bold">Activate your account</h2>
                                <hr />
                                {/* alert msg show div */}
                                <div
