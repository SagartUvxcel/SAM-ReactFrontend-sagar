                  ...
                  <div className="row mt-md-5">
                    <div className="col-md-6">
                      <button className="w-100 btn btn-primary text-capitalize common-btn-font" onClick={navigateToPaymentPage}>
                        Subscribe
                        {/* to {selectedPlanDetails.selectedPlanName && selectedPlanDetails.selectedPlanName.toLowerCase().replace(' plan', '')}{" "} */}
                    ...
                    <div className="col-md-6 mt-4 mt-md-0">
                      ...
                      >
                        Free Trial
                        {/* ({selectedPlanDetails.selectedPlanName && selectedPlanDetails.selectedPlanName.toLowerCase().replace(' plan', '')}){" "} */}
                        <i className="bi bi-chevron-right"></i>
                      </button>
                    </div>
                  </div>
