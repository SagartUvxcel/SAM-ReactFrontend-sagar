...
export const PaymentInformation = () => {
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      // const response = await axios.post("/api/process-payment", dataToPost, { headers: authHeaders });
      // if(response.data){
  ...
  useEffect(() => {
    if (dataFromSubscriptionPage) {
      console.log(dataFromSubscriptionPage);
      setPlanDetails({
                ...
                <div id="card-element">
                  ...
                  <form onSubmit={handleSubmit}>
                    ...
                    <div className="text-center">
                      ...
                      <button type="submit" className="btn btn-primary text-capitalize common-btn-font px-4 mt-4">Subscribe</button>
                    </div>
                  </form>
                </div>
              </div>
